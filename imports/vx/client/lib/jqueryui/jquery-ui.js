 ...
 */
    ...
    var widgetsSortable = $.widget( "ui.sortable", $.ui.mouse, {
        ...
        options: {
            ...
            stop: null,
            update: null,
            // 2-28-2021 DL - New listeners to hide and show dragged elements for multi-select:
            hideDragged: null,
            showDragged: null
        },
        ...
        cancel: function() {
            ...
            if ( this.dragging ) {
                ...
                if ( this.options.helper === "original" ) {
                    ...
                    // 03-14-2021 - DL - We'll handle show ourselves in UX
                    //this.currentItem.show();
                    this._trigger( "showDragged", event, this._uiHash() );
                }
