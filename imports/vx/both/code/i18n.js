...
Meteor.i18nMessages.common = {
    ...
    alert_deployment_message_restore : {
        en : "If you press [Confirm] the system will restore records into {{targetDomainName}} using data from a snapshot taken on {{dateTime}}.",
        rx : "$If you press [Confirm] the system will restore records into {{targetDomainName}} using data from a snapshot taken on {{dateTime}}.$"
    },
